...
namespace SuperPlayer.Internal
{
        [Flags]
        ...
        public class WindowsThumbnailProvider
        {
                ...
                public static Bitmap CreateAlphaBitmap(Bitmap srcBitmap, System.Drawing.Imaging.PixelFormat targetPixelFormat)
                {
                        ...
                        try
                        {
                                for (int y = 0; y <= srcData.Height - 1; y++)
                                {
                                        ...
                                        {
                                                System.Drawing.Color pixelColor = System.Drawing.Color.FromArgb(Marshal.ReadInt32(srcData.Scan0, (srcData.Stride * y) + (4 * x)));
